...
PRIVATE_CONFIG=tm1.conf nohup geth --datadir qdata/dd1 $GLOBAL_ARGS --rpcport 22000 --port 21000 2>>qdata/logs/1.log &
...
PRIVATE_CONFIG=tm1.conf geth --exec 'loadScript("unlockAccounts.js")' attach ipc:qdata/dd1/geth.ipc
